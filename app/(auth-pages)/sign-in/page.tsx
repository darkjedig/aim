    ...
    <div className="relative flex items-center justify-center min-h-screen py-12 bg-gray-900">
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        <form className="bg-gray-800/80 backdrop-blur-sm shadow-lg rounded-lg px-8 pt-6 pb-8 mb-4">
          ...
          <SubmitButton pendingText="Signing In..." formAction={signInAction} className="w-full bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-bold py-3 px-4 rounded-md focus:outline-none focus:shadow-outline text-lg">
            Sign in
          </SubmitButton>
          <FormMessage message={searchParams} />
