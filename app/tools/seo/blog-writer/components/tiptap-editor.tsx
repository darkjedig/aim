  ...
  useEffect(() => {
    if (editor && internalLinkingMode) {
      editor.setOptions({
        editorProps: {
          attributes: {
            class: 'prose prose-invert max-w-none p-4 bg-gray-900 selection:bg-pink-500/50 text-gray-300', // Updated text color
          },
        },
      })
    } else if (editor) {
      editor.setOptions({
        editorProps: {
          attributes: {
            class: 'prose prose-invert max-w-none p-4 bg-gray-900 text-gray-300', // Updated text color
          },
        },
      })
    }
    ...
    <div className="border border-gray-600 rounded-md overflow-hidden">
      <div className="bg-gray-800 p-2 flex items-center space-x-2">
        <Button
          ...
          className="text-gray-300 hover:bg-purple-500/20 hover:text-purple-300" // Updated hover state
        >
            ...
            <TooltipTrigger asChild>
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  className="border-gray-400 text-purple-500" // Updated checkbox color
                />
                <Label
